...
from gcode2dplotterart.enums import PlotterTypeEnum, SpecialInstructionEnum, PlottingInstructionTypeEnum
import json
...
class TestSnapshot(unittest.TestCase):
  ...
  def testSnapshot(self):
    ...
    plotter.layers[layer] \
      .add_point(30,40) \
      .add_circle(1,1, 10)\
      .add_rectangle(50,50,75,75) \
      .add_path([(10,10), (20,20), (30,30)]) \
      .add_line(0, 15, 0, 15) \
      .add_comment("Test comment", instruction_type=PlottingInstructionTypeEnum.teardown) \
      .add_special(SpecialInstructionEnum.pause, instruction_type=PlottingInstructionTypeEnum.setup)
