...
from .enums import HandleOutOfBoundsEnum, SpecialInstructionEnum, PlotterTypeEnum, PlottingInstructionTypeEnum, UnitsEnum, PlotterTypeEnum
...
class Layer:
  def __init__(self, x_min: float, y_min: float, x_max: float, y_max: float, units: UnitsEnum, feed_rate: float, plotter_type: PlotterTypeEnum, handle_out_of_bounds: HandleOutOfBoundsEnum, preview_only: bool=False):
  ...
  def set_feed_rate(self, feed_rate: float, instruction_type: PlottingInstructionTypeEnum=PlottingInstructionTypeEnum.plotting) -> Self:
    """
  ...
  def set_mode_to_draw(self, instruction_type:PlottingInstructionTypeEnum=PlottingInstructionTypeEnum.plotting) -> Self:
    """
  ...
  def set_mode_to_navigation(self, instruction_type:PlottingInstructionTypeEnum=PlottingInstructionTypeEnum.plotting) -> Self:
    """
  ...
  def add_point(self, x: float, y: float, instruction_type: PlottingInstructionTypeEnum=PlottingInstructionTypeEnum.plotting) -> Self:
    """
  ...
  def add_line(self, x_start: float, y_start: float, x_end: float, y_end: float, instruction_type:PlottingInstructionTypeEnum=PlottingInstructionTypeEnum.plotting) -> Self:
    points = [
      (x_start, y_start),
      (x_end, y_end)
    ]
  ...
  def add_path(self, points: List[Tuple[float, float]], instruction_type:PlottingInstructionTypeEnum=PlottingInstructionTypeEnum.plotting) -> Self:
    """
    Add a path layer.
  ...
  def add_special(self, special_instruction: SpecialInstructionEnum, instruction_type: PlottingInstructionTypeEnum=PlottingInstructionTypeEnum.plotting) -> Self:
    """
    ...
    self.instructions[instruction_type].append(SpecialInstruction(self.plotter_type, special_instruction))
    return self
      
  def add_comment(self, text: str, instruction_type: PlottingInstructionTypeEnum) -> Self:
    """
  ...
  def add_rectangle(self, x_start: float, y_start: float, x_end: float, y_end: float, instruction_type: PlottingInstructionTypeEnum=PlottingInstructionTypeEnum.plotting) -> Self:
    """
  ...
  def add_circle(self, x_center: float, y_center: float, radius: float, num_points: int=36, instruction_type:PlottingInstructionTypeEnum=PlottingInstructionTypeEnum.plotting) -> Self:
    """
