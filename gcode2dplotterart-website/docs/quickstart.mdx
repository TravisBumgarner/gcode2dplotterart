...
**A video tutorial is also available. Run `pip install gcode2dplotterart` then head over to [YouTube](https://www.youtube.com/watch?v=-7CjcRVRleQ&ab_channel=TravistheMaker) to watch.**
