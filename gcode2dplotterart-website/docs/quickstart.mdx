...
Check out the [plotting tips](./documentation/plotting_tips) and [coding tips](./documentation/code_tips). Find some inspiration in the [plotting gallery](./category/gallery). Dive into the [API docs](./category/api).
