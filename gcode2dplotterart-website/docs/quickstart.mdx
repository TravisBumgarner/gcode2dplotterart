...
******************************A video tutorial is also available. Run `pip install gcode2dplotterart` then head over to YouTube to watch the [2D Plotter](https://www.youtube.com/watch?v=-7CjcRVRleQ&ab_channel=TravistheMaker) or 3D Printer versions. **
