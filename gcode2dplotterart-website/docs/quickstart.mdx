...
plotter=Plotter2D(
  ...
  include_border_layer=False, # Don't plot a border layer
  include_preview_layer=True, # Include a preview layer that'll outline the print without plotting anything.
