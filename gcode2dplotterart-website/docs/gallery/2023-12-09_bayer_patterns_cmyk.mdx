---
description: An exploration into making bayer filters but with CMYK instead of RGB.
image: /img/gallery/2023-12-09_bayer_patterns_cmyk/example1.jpg
---
...
An exploration into making [bayer filters](https://en.wikipedia.org/wiki/Bayer_filter) but with CMYK instead of RGB.

## Images

![example of plotted code](/img/gallery/2023-12-09_bayer_patterns_cmyk/example1.jpg)

## Inputs

![preview screenshot](/img/gallery/2023-12-09_bayer_patterns_cmyk/preview0.png)

## Plotter Preview

![preview screenshot](/img/gallery/2023-12-09_bayer_patterns_cmyk/preview.png)
