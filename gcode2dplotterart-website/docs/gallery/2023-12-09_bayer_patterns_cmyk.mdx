...
image: /img/gallery/10_cmyk_bayer_patterns/example1.jpg
---
...
![example of plotted code](/img/gallery/10_cmyk_bayer_patterns/example1.jpg)


## Plotter Preview

Image used to feed into script:
![preview screenshot](/img/gallery/10_cmyk_bayer_patterns/preview0.png)
![preview screenshot](/img/gallery/10_cmyk_bayer_patterns/preview.png)
