...
![example of plotted code](/img/gallery/bunch_of_lines/example1.jpg)
![example of plotted code](/img/gallery/bunch_of_lines/example2.jpg)


## Plotter Preview

![preview screenshot](/img/gallery/bunch_of_lines/preview.png)
