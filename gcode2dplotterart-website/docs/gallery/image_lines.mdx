...
![example of plotted code](/img/gallery/image_lines/example1.jpg)
![example of plotted code](/img/gallery/image_lines/example2.jpg)


## Plotter Preview

![preview screenshot](/img/gallery/image_lines/preview.png)
