...
![example of plotted code](/img/gallery/wandering_lines/example1.jpg)
![example of plotted code](/img/gallery/wandering_lines/example2.jpg)


## Plotter Preview

![preview screenshot](/img/gallery/wandering_lines/preview.png)
