...
![example of plotted code](/img/gallery/11_diagonal_lines/example1.avif)
![example of plotted code](/img/gallery/11_diagonal_lines/example2.avif)
![plotter adaptor](/img/gallery/11_diagonal_lines/example3.avif)
![example of plotted code](/img/gallery/11_diagonal_lines/example4.avif)
![plotter adaptor](/img/gallery/11_diagonal_lines/example5.avif)


## Inputs

![sample photo](/img/gallery/11_diagonal_lines/input.jpg)

## Plotter Preview

![preview screenshot](/img/gallery/11_diagonal_lines/preview.png)
