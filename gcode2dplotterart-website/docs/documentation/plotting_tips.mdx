...
When attaching a [plotting instrument](./terminology#plotting-instrument) to the [plotter head](./terminology#plotter-head), note its height above the [plotting surface](./terminology#plotting-surface). When changing layers and using a new plotting instrument, be sure that the height above the plotting surface is the same as the previous plotting instrument.
