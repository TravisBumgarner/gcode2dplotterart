...
On some plotting devices, there are switches along each axis. When your plotting device hits these switches, it'll stop moving. However, if your device does not have limit switches, it's possible that the plotter head can go beyond these limits. The sound is not pleasant as your motors grind and your plotter head slams into the wall.  

## Plotter head

This is the point where your drawing device (pen, market, paint brush, etc.) is attached to your plotting device. When the plotter head is raised it is not in contact with whatever you're drawing on. 
