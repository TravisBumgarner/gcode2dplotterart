...
1. **For 3D printers only**, move the plotting head so that the plotting instrument's point is comfortably touching the plotting surface. **Write this number down.**
