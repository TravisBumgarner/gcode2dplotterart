...
<a id="gcode2dplotterart/Plotter.Plotter2d"></a>
...
<a id="gcode2dplotterart/Plotter.Plotter2d.add_layer"></a>

#### add\_layer

```python
def add_layer(title: str, preview_only: bool = False) -> Layer2d
```
...
<a id="gcode2dplotterart/Plotter.Plotter3d"></a>
...
<a id="gcode2dplotterart/Plotter.Plotter3d.add_layer"></a>

#### add\_layer

```python
def add_layer(title: str, preview_only: bool = False) -> Layer3d
```
