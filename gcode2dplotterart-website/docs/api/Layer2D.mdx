...
add_circle(
  ...
  radius: float
  num_points: int = 36
  plotting_phase: Union[Literal['setup']
  Literal['plotting']
...
add_instruction(
  self
  instruction: Union[gcode2dplotterart.InstructionWithArguments.InstructionPause
  gcode2dplotterart.InstructionWithArguments.InstructionFeedRate
  gcode2dplotterart.InstructionWithArguments.InstructionComment
  gcode2dplotterart.InstructionWithArguments.Instruction3DPrinterPlottingHeight
  gcode2dplotterart.InstructionWithArguments.Instruction3DPrinterNavigationHeight
  gcode2dplotterart.SimpleInstruction.Instruction2DPlotterNavigationHeight
  gcode2dplotterart.SimpleInstruction.Instruction2DPlotterPlottingHeight
  gcode2dplotterart.SimpleInstruction.InstructionUnitsMM
  gcode2dplotterart.SimpleInstruction.InstructionProgramEnd]
  plotting_phase: Union[Literal['setup']
  Literal['plotting']
  Literal['teardown']] = 'plotting'
)
