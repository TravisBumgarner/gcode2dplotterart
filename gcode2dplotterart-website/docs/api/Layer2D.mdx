...
```python
add_circle(
self, x_center: float, y_center: float, radius: float, num_points: int = 36, instruction_phase: Union[Literal['setup'], Literal['plotting'], Literal['teardown']] = 'plotting' )
 ->  Self
```
...
```python
add_line(
self, x_start: float, y_start: float, x_end: float, y_end: float, instruction_phase: Union[Literal['setup'], Literal['plotting'], Literal['teardown']] = 'plotting' )
 ->  Self
```
...
```python
add_path(
self, points: List[Tuple[float, float]], instruction_phase: Union[Literal['setup'], Literal['plotting'], Literal['teardown']] = 'plotting' )
 ->  Self
```
...
```python
add_point(
self, x: float, y: float, instruction_phase: Union[Literal['setup'], Literal['plotting'], Literal['teardown']] = 'plotting' )
 ->  Self
```
