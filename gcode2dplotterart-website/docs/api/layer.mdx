...
<a id="gcode2dplotterart/Layer.SimpleInstructionDrawingHeight2DPlotter"></a>

## SimpleInstructionDrawingHeight2DPlotter Objects
...
<a id="gcode2dplotterart/Layer.SimpleInstructionNavigationHeight2DPlotter"></a>

## SimpleInstructionNavigationHeight2DPlotter Objects
...
<a id="gcode2dplotterart/Layer.SpecialInstructionDrawingHeight3DPrinter"></a>

## SpecialInstructionDrawingHeight3DPrinter Objects
...
<a id="gcode2dplotterart/Layer.SpecialInstructionDrawingHeight3DPrinter.to_g_code"></a>
...
<a id="gcode2dplotterart/Layer.SpecialInstructionNavigationHeight3DPrinter"></a>
...
<a id="gcode2dplotterart/Layer.SpecialInstructionNavigationHeight3DPrinter.to_g_code"></a>
...
<a id="gcode2dplotterart/Layer.Layer2d.set_mode_to_draw"></a>

#### set\_mode\_to\_draw

```python
def set_mode_to_draw(instruction_type: TInstructionType = "plotting") -> Self
```
...
<a id="gcode2dplotterart/Layer.Layer3d.set_mode_to_draw"></a>
