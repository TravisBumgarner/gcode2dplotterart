...
<a id="gcode2dplotterart/Layer.SpecialInstruction.pen_up"></a>
...
<a id="gcode2dplotterart/Layer.SpecialInstruction.pen_down"></a>
...
def set_feed_rate(feed_rate,
                  instruction_type=PlottingInstructionTypeEnum.plotting)
```
...
```python
def lower_print_head(instruction_type=PlottingInstructionTypeEnum.plotting)
```
...
```python
def raise_print_head(instruction_type=PlottingInstructionTypeEnum.plotting)
```
...
```python
def add_special(special_instruction: SpecialInstructionEnum,
                instruction_type=PlottingInstructionTypeEnum.plotting)
```
...
```python
def add_comment(text: str, instruction_type)
```
